...
export function DetailPageSidebar({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: designSystem.spacing[1] }}>
      ...
      <Divider style={{ margin: `${designSystem.spacing[2]} 0` }} />
...
export default function DetailPage() {
  ...
  return (
    <div style={{
      ...
      {/* 主内容区 - Tabs */}
      <Card size="small" style={{ flex: 1, display: 'flex', flexDirection: 'column', borderRadius: designSystem.borderRadius.lg, minHeight: 0 }}>
        <Tabs
            activeKey={activeTab}
            ...
            items={[
              {
                ...
                label: '基本信息',
                children: (
                  <div style={{ overflow: 'auto', height: '100%', padding: designSystem.spacing[1] }}>
                    {/* 详细信息 */}
              ...
              },
              {
                ...
                children: (
                  <div style={{ padding: designSystem.spacing[1], height: '100%', overflow: 'auto' }}>
                    <Table
                      size="small"
